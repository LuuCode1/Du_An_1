 ...
 * @author leduc
 */
public class Add_chatlieu extends javax.swing.JDialog {

    ChatLieu cl = new ChatLieu();
    chatLieu_service clsv = new chatLieu_service();

    /**
     * Creates new form Add_chatlieu
     */
    public Add_chatlieu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_chatlieu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
