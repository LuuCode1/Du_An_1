...
public class BanHang extends javax.swing.JPanel {
    ...
    HoaDonChiTiet_service hdctsv = new HoaDonChiTiet_service();
    ...
    public BanHang() {
        ...
        initTable();
        configTolCol();
        fillTable_hoadon(hoadon_service.Select(trangthai));
        
    }
    
    void fillTable_hoadon(List<HoaDon> list) {
        model = (DefaultTableModel) tblHoaDon.getModel();
        model.setRowCount(0);
        list = hoadon_service.Select(trangthai);
...
public void configTolCol() {
    ...
    private void tblHoaDonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblHoaDonMouseClicked
        ...
        model.setRowCount(0);
        List<HoaDonChiTiet> listhdct = hdctsv.Select_ma(ma);
        for (HoaDonChiTiet hoaDonChiTiet : listhdct) {
            model.addRow(hoaDonChiTiet.todata_giohang());
        }
